...
public class WaveManager {
    ...
    private void createWaves() {
        ...
        waves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2, 3, 3, 3, 3, 3, 3, 3, 3, 1))));
        waves.add(new Wave(new ArrayList<Integer>(Arrays.asList(3, 2, 0, 1, 0, 3, 3, 0, 2, 1))));
        waves.add(new Wave(new ArrayList<Integer>(Arrays.asList(2, 2, 2, 1, 2, 2, 1, 2, 2, 1))));
    }
